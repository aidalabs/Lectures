...
* CNN 모델 기반 이미지 객체 검출(탐지)
  ...
  * [Anomaly Detection](../LectureFiles/pdf/DL23_Anomaly_Detection.pdf)
  <br/>
* YOLO 모델 기반 이미지 객체 검출(탐지)
  * [YOLO 모델 아키텍쳐 분석](../LectureFiles/pdf/DL10_YOLO아키텍처분석(v5).pdf)
  ...
  * [데이터 라벨링](../LectureFiles/pdf/20220811_Data_Labeling.pdf)
...
* 딥러닝 프레임워크
  ...
  * [Tensor Hub / 전이 학습을 통한 모델 생성](../LectureFiles/src/DL070_Tensorflow_Hub.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/aidalabs/Lectures/blob/main/LectureFiles/src/DL070_Tensorflow_Hub.ipynb)
  <br/>
* 머신러닝 시스템
...
* 부자재(단추) 불량 분류 프로젝트 실습
  ...
  * [불량 부자재 이미지 핸들링 및 전처리](../LectureFiles/src/DL008_YOLOv8.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/aidalabs/Lectures/blob/main/LectureFiles/src/DL008_YOLOv8.ipynb)
